...
OUTPUT_PATH = "/tmp/credit-note.pdf"
XML_PATH    = "/tmp/credit-note.xml"
...
# Credit notes (TypeCode 381) use positive amounts — the document type signals the credit.
